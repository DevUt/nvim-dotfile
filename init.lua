...
-- This must happen before loading any other plugin
vim.g.mapleader = " "
...
-- Enable mouse mode, helps in resizing splits and other
vim.opt.mouse = "a" -- The 'a' tells it to enable for all modes

-- Don't display mode, the statusline will tell
	...
	},
	{
		...
		config = function()
			require("competitest").setup({
				...
				template_file = { cpp = "~/Projects/CP/boilers/boiler_cpp.cpp" },
				received_contests_problems_path = "$(CWD)/$(JAVA_MAIN_CLASS).$(FEXT)",
